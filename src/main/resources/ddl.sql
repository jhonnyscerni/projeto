...
create table consulta (cod_consulta bigint not null auto_increment, class_name varchar(255), convenio_enum varchar(255), data_hora datetime, local_atendimento varchar(255), observacao varchar(255), procedimento_enum varchar(255), start datetime, status_consulta_enum varchar(255), title varchar(255), valor_total decimal(19,2), clinica bigint, forma_pagamento_id bigint not null, paciente bigint, profissional bigint, primary key (cod_consulta)) engine=InnoDB
...
alter table consulta add constraint FKmsbqc8cbj7t1865bptf6n9k9f foreign key (forma_pagamento_id) references forma_pagamento (id)
