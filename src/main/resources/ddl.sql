...
create table grupo_permissao (cod_grupo bigint not null, cod_permissao bigint not null, primary key (cod_grupo, cod_permissao)) engine=InnoDB
...
create table usuario (cod_usuario bigint not null auto_increment, dt_cad_usuario datetime not null, email varchar(255), nm_usuario varchar(255), senha varchar(255), primary key (cod_usuario)) engine=InnoDB
create table usuario_grupo (cod_usuario bigint not null, cod_grupo bigint not null, primary key (cod_usuario, cod_grupo)) engine=InnoDB
