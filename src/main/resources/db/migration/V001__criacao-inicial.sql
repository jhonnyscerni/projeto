...
create table consulta (cod_consulta bigint not null auto_increment, convenio_enum varchar(255), data_hora datetime, local_atendimento varchar(255), observacao varchar(255), procedimento_enum varchar(255), status_consulta_enum varchar(255), start datetime, title varchar(255), class_name varchar(255), clinica bigint, paciente bigint, profissional bigint, primary key (cod_consulta)) engine=InnoDB default charset=utf8;
