...
create table forma_pagamento (id bigint not null auto_increment, data_atualizacao datetime, descricao varchar(255) not null, primary key (id)) engine=InnoDB engine=InnoDB default charset=utf8;
-- create table hibernate_sequence (next_val bigint) engine=InnoDB default charset=utf8;
