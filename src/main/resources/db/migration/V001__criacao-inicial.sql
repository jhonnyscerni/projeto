...
create table estado (cod_estado bigint not null auto_increment, silga varchar(255) not null, nm_estado varchar(255) not null, primary key (cod_estado)) engine=InnoDB default charset=utf8;
...
create table usuario (tp varchar(31) not null, cod_usuario bigint not null auto_increment, ativado bit, endereco_bairro varchar(255), celular varchar(255), cpf varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), dt_cad_usuario datetime not null, dt_nascimento datetime, email varchar(255), endereco_logradouro varchar(255), nm_usuario varchar(255), endereco_numero varchar(255), senha varchar(255), sexo varchar(255), telefone varchar(255), cpf_responsavel varchar(255), nome_mae varchar(255), nome_pai varchar(255), conselho varchar(255), formacao_academica varchar(255), registro_conselho varchar(255), endereco_cidade_id bigint, cod_profissional bigint not null default 0, primary key (cod_usuario)) engine=InnoDB default charset=utf8;
